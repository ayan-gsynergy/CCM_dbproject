CREATE TABLE [history].[customer_billing_accounts] (
    [id]                        INT           NOT NULL,
...
CREATE CLUSTERED INDEX [ix_customer_billing_accounts]
    ON [history].[customer_billing_accounts]([_valid_to] ASC, [_valid_from] ASC);
GO
